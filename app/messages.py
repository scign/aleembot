class NewMemberMessage:
    """
    Constructs the message for new members and stores the
    ...
    WELCOME_BLOCK = {
        ...
        "text": {
            "type": "mrkdwn",
            "text": (
                "Welcome to The Artificial Intelligence Study Biddies workspace! :wave: We're so glad you're here. :blush:\n\n"
